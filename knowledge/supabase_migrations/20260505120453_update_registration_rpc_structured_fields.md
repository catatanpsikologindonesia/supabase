# Migration: update_registration_rpc_structured_fields

- **Timestamp**: 20260505120453
- **Applied At**: 2026-05-05 12:04:53
...
begin
  ...
  values (
    ...
    nullif(registration_payload ->> 'otherOccupation', ''),
    nullif(registration_payload ->> 'provinceDomainId', '')::integer,
    nullif(registration_payload ->> 'cityDomainId', '')::integer,
    nullif(registration_payload ->> 'districtDomainId', '')::integer,
    nullif(registration_payload ->> 'subdistrictDomainId', '')::integer,
    nullif(registration_payload ->> 'postalCodeDomainId', '')::integer,
    nullif(registration_payload ->> 'addressLine', ''),
  ...
  values (
    ...
    nullif(registration_payload ->> 'guardianProvinceDomainId', '')::integer,
    nullif(registration_payload ->> 'guardianCityDomainId', '')::integer,
    nullif(registration_payload ->> 'guardianDistrictDomainId', '')::integer,
    nullif(registration_payload ->> 'guardianSubdistrictDomainId', '')::integer,
    nullif(registration_payload ->> 'guardianPostalCodeDomainId', '')::integer,
    nullif(registration_payload ->> 'guardianAddressLine', ''),
